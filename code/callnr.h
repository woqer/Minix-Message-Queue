...
#define TASK_REPLY	  121 	/* toVFS: rpely code from drivers, not
				really a standalone call */
#define MAPDRIVER	  122 /* to VFS, map a device */

/* New calls of message_queue */
#define MQ_OPEN         	35
#define MQ_CLOSE        	44
#define MQ_SETATTR      	56
#define MQ_GETATTR    		58
#define MQ_SEND       		69
#define MQ_RECEIVE    		70
#define MQ_REQNOTIFY  		79
#define MQ_ADDADMINUSER  	97
#define MQ_REMOVEADMINUSER	103
#define MQ_CREATMQGROUP 	105
#define MQ_DELETEMQGROUP	108
