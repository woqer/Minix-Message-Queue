...
int (*call_vec[])(void) = {
	...
	no_sys,			/* 54 = ioctl	*/
	no_sys,			/* 55 = fcntl	*/
	do_mq_setattr,					/* 56 = mq_setattr	*/
	no_sys,			/* 57 = unused	*/
	do_mq_getattr,					/* 58 = mq_getattr	*/
	do_exec,		/* 59 = execve	*/
	no_sys,			/* 60 = umask	*/
	no_sys,			/* 61 = chroot	*/
	do_set,			/* 62 = setsid	*/
	...
	do_mq_send,						/* 69 = mq_send	*/
	do_mq_receive,					/* 70 = mq_receive	*/
	...
	do_mq_reqnotify,				/* 79 = mq_reqnotify */
	no_sys,			/* 80 = (getdents) */
	no_sys,  		/* 81 = unused */
	no_sys, 		/* 82 = (fstatfs) */
	no_sys, 		/* 83 = unused */
	...
	no_sys,			/* 95 = (fchmod) */
	no_sys,			/* 96 = (fchown) */
	do_mq_addadminuser,				/* 97 = addadminuser */
	...
	do_mq_removeadminuser,				/* 103 = removeadminuser */
	do_getprocnr,	/* 104 = getprocnr */
	do_mq_createmqgroup,				/* 105 = creat_mqgroup */
	do_get,			/* 106 = issetugid */
	do_getepinfo_o,	/* 107 = getepinfo XXX: old implementation*/
	do_mq_deletemqgroup,				/* 108 = mq_deletegroup */
	no_sys,			/* 109 = unused */
	no_sys,			/* 110 = unused */
